...
for k,v in pairs( WTT ) do
	list.Set( "SBEP_WeaponMountToolModels", k , v )
end

local WMMT = {}
			WMMT[ "models/Spacebuild/milcock4_wing1.mdl"  ] = { type = "Wing"	, V = Vector(0,0,0)		, A = Angle(0,0,90) , 
																HP = {	{ Type = {"Small","Tiny"} , Pos	= Vector(0,24 ,0 ) , Angle = Angle(0,0,180) } } }
			WMMT[ "models/Spacebuild/milcock4_wing2.mdl"  ] = { type = "Wing"	, V = Vector(0,0,0)		, A = Angle(0,0,90)	, 
																HP = {	{ Type = {"Small","Tiny"} , Pos	= Vector(0,16 ,0 ) , Angle = Angle(0,0,180) } } }
			WMMT[ "models/Spacebuild/milcock4_wing3.mdl"  ] = { type = "Wing"	, V = Vector(0,0,0)		, A = Angle(0,0,90)	, 
																HP = {	{ Type = {"Small","Tiny"} , Pos	= Vector(0,21 ,5 ) , Angle = Angle(0,0,0  ) } ,
			...
			WMMT[ "models/Spacebuild/milcock4_wing4.mdl"  ] = { type = "Wing"	, V = Vector(0,0,0)		, A = Angle(0,0,90)	, 
																HP = {	{ Type = {"Small","Tiny"} , Pos	= Vector(0,64 ,5 ) , Angle = Angle(0,0,0  ) } ,
																		{ Type = {"Small","Tiny"} , Pos	= Vector(0,64 ,-5) , Angle = Angle(0,0,180) } } }
			WMMT[ "models/Spacebuild/milcock4_wing5l.mdl" ] = { type = "Wing"	, V = Vector(0,0,0)		, A = Angle(0,0,90)	, 
																HP = {	{ Type = {"Small","Tiny"} , Pos	= Vector(-11,28,5) , Angle = Angle(0,0,180) } } }
			WMMT[ "models/Spacebuild/milcock4_wing5r.mdl" ] = { type = "Wing"	, V = Vector(0,0,0)		, A = Angle(0,0,-90), 
																HP = {	{ Type = {"Small","Tiny"} , Pos	= Vector(-11,-28,5), Angle = Angle(0,0,180) } } }
			WMMT[ "models/Spacebuild/milcock4_wing6.mdl"  ] = { type = "Wing"	, V = Vector(0,0,0)		, A = Angle(0,0,90)	, 
																HP = {	{ Type = {"Small","Tiny"} , Pos	= Vector(0,96 ,0 ) , Angle = Angle(0,0,-90) } } }
			WMMT[ "models/Spacebuild/milcock4_wing7.mdl"  ] = { type = "Wing"	, V = Vector(-5,27,-4)	, A = Angle(0,0,90)	, 
																HP = {	{ Type = {"Small","Tiny"} , Pos	= Vector(-5,-4,14) , Angle = Angle(0,0,0  ) } ,
																		{ Type = {"Small","Tiny"} , Pos	= Vector(-5,-4,-6) , Angle = Angle(0,0,180) } } }

			WMMT[ "models/Slyfo/rover1_backpanel.mdl"	  	] = { type = "RBackPanel"	, V = Vector(0,0,-6), A = Angle(0,0,0) , 
																	HP = {	{ Type = "Small" 		   , Pos = Vector(0,14,-12) } } }
			WMMT[ "models/Slyfo/rover1_leftpanel.mdl"	  	] = { type = "RLeftPanel"	, V = Vector(0,0,0)	, A = Angle(0,0,0) }
			WMMT[ "models/Slyfo/rover1_leftpanelmount.mdl"	] = { type = "RLeftPanel"	, V = Vector(0,0,0)	, A = Angle(0,0,0) , 
			...
			WMMT[ "models/Slyfo/rover1_rightpanelmount.mdl"	] = { type = "RRightPanel"	, V = Vector(0,0,0)	, A = Angle(0,0,0) , 
...
local DCMT = {}
			DCMT[ "models/smallbridge/ship parts/sblandramp.mdl"  	] = { ALType = "SWSHA", Compatible = { { Type = "SWSHB", AF = 0, AYaw = 180 } } , 
																	EfPoints = 	{	{ vec = Vector(-65 , -110 ,  50 ) , sp = 0 } , 
																					{ vec = Vector(-90 ,   95 , -60 ) , sp = 3 } , 
																					{ vec = Vector( 90 ,   95 , -60 ) , sp = 0 } , 
																					{ vec = Vector( 65 , -110 ,  50 ) , sp = 1 } } }
			DCMT[ "models/smallbridge/ship parts/sblanduramp.mdl"  	] = { ALType = "SWSHB", Compatible = { { Type = "SWSHA", AF = 0, AYaw = 180 } } ,
																	EfPoints = {	{ vec = Vector(-65 ,  100 ,  60 ) , sp = 0 } , 
																					{ vec = Vector(-90 , -110 , -50 ) , sp = 3 } , 
																					{ vec = Vector( 90 , -110 , -50 ) , sp = 0 } , 
																					{ vec = Vector( 65 ,  100 ,  60 ) , sp = 1 } } }
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
			DCMT[ "models/smallbridge/panels/sbpaneldockin.mdl"  	] = { ALType = "PLockA", Compatible = { { Type = "PLockB", AF = -4.65 } }, 
			...
			DCMT[ "models/smallbridge/panels/sbpaneldockout.mdl"  	] = { ALType = "PLockB", Compatible = { { Type = "PLockA", AF = 4.65 } },  
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
			DCMT[ "models/slyfo/airlock_docksys.mdl"			  	] = { ALType = "MedGLB", Compatible = { { Type = "MedGLB", AYaw = 180 } },
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
			DCMT[ "models/smallbridge/ship parts/sblandrampdw.mdl"  ] = { ALType = "DWSHA", Compatible = { { Type = "DWSHB", AF = 0, AYaw = 180} } , 
																	EfPoints = 	{	{ vec = Vector(-175 , -110 ,  50 ) , sp = 0 } , 
																					{ vec = Vector(-200 ,   95 , -60 ) , sp = 3 } , 
																					{ vec = Vector( 200 ,   95 , -60 ) , sp = 0 } , 
																					{ vec = Vector( 175 , -110 ,  50 ) , sp = 1 } } }
			DCMT[ "models/smallbridge/ship parts/sblandurampdw.mdl"  ] = { ALType = "DWSHB", Compatible = { { Type = "DWSHA", AF = 0, AYaw = 180} } , 
																	EfPoints = 	{	{ vec = Vector(-175 ,  100 ,  60 ) , sp = 0 } , 
																					{ vec = Vector(-200 , -110 , -50 ) , sp = 3 } , 
																					{ vec = Vector( 200 , -110 , -50 ) , sp = 0 } , 
																					{ vec = Vector( 175 ,  100 ,  60 ) , sp = 1 } } }
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
			DCMT[ "models/smallbridge/ship parts/sblandrampdwdh.mdl" ] = { ALType = "DWDHA", Compatible = { { Type = "DWDHB", AF = 0, AYaw = 180} } ,
																	EfPoints = 	{	{ vec = Vector(-175 , -110 , 180 ) , sp = 0 } , 
																					{ vec = Vector(-200 ,   90 , -60 ) , sp = 3 } , 
																					{ vec = Vector( 200 ,   90 , -60 ) , sp = 0 } , 
																					{ vec = Vector( 175 , -110 , 180 ) , sp = 1 } } }
			DCMT[ "models/smallbridge/ship parts/sblandurampdwdh.mdl"] = { ALType = "DWDHB", Compatible = { { Type = "DWDHA", AF = 0, AYaw = 180} } ,
																	EfPoints = 	{	{ vec = Vector(-175 ,  100 , 190 ) , sp = 0 } , 
																					{ vec = Vector(-200 , -120 , -60 ) , sp = 3 } , 
																					{ vec = Vector( 200 , -120 , -60 ) , sp = 0 } , 
																					{ vec = Vector( 175 ,  100 , 190 ) , sp = 1 } } }
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
			DCMT[ "models/smallbridge/elevators,small/sbselevb.mdl"] = { ALType = "ElevSU" , Compatible = { { Type = "ElevSU", AU = 65.1, RYaw = 90, ARoll = 180 }, 
																	...
																	EfPoints = 	{	{ vec = Vector(-60.45 ,  60.45 , 69.75 ) , sp = 1 } , 
																					...
																					{ vec = Vector( 60.45 ,  60.45 , 69.75 ) , sp = 0 } } }
			DCMT[ "models/smallbridge/elevators,small/sbselevt.mdl"] = { ALType = "ElevSD" , Compatible = { { Type = "ElevSD", AU = -65.1, RYaw = 90, ARoll = 180 }, 
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
			DCMT[ "models/props_phx/construct/metal_wire1x1.mdl"] = { ALType = "PHX1x1" , Compatible = { { Type = "PHX1x1", AU = 6, RYaw = 90, ARoll = 180 } },
																	EfPoints = 	{	{ vec = Vector(-20 ,  20 , 8 ) , sp = 0 } , 
																					{ vec = Vector(-20 , -20 , 8 ) , sp = 2 } , 
																					{ vec = Vector( 20 , -20 , 8 ) , sp = 0 } , 
																					{ vec = Vector( 20 ,  20 , 8 ) , sp = 4 } } }
			DCMT[ "models/props_phx/construct/metal_wire2x2b.mdl"] = { ALType = "PHX2x2" , Compatible = { { Type = "PHX2x2", AU = 6, RYaw = 90, ARoll = 180 } },
