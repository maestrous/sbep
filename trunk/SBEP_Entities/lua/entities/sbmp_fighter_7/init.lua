...
function ENT:Initialize()
	...
	self.Entity:SetModel( "models/Spacebuild/milcock7_emount1.mdl" ) 
	self.Entity:SetName("KATANA")
...
function ENT:SpawnFunction( ply, tr )
	...
	local ent = ents.Create( "sbmp_fighter_7" )
	ent:SetPos( SpawnPos )
	ent:Spawn()
	ent:Initialize()
	ent:Activate()
	...
	ent2:SetModel( "models/Spacebuild/mil_cock_7.mdl" ) 
	ent2:SetPos( ent:LocalToWorld(Vector(50,0,0)) )
