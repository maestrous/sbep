...
function ENT:Initialize()
	...
	self.Entity:SetModel( "models/Slyfo/arwing_engineleft.mdl" ) 
	self.Entity:SetName("ArwingEngineLeft")
	...
	wing:SetModel( "models/Slyfo/arwing_wingleft.mdl" )
...
function ENT:SpawnFunction( ply, tr )
	...
	local ent = ents.Create( "arwing_left" )
	ent:SetPos( SpawnPos )
	ent:Spawn()
	ent:Activate()
	ent.SPL = ply
