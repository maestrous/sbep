...
function ENT:Initialize()
	self.Entity:SetModel( "models/smallbridge/ships/sbfrigate1.mdl" ) 
	self.Entity:SetName("Hermes")
	...
	self.HP[1]["Pos"]	= Vector(-280,-215,-10)
	self.HP[1]["Angle"] = Angle(0,0,80)
	self.HP[2]			= {}
	self.HP[2]["Ent"]	= nil
	self.HP[2]["Type"]	= {"Medium","Large"}
	self.HP[2]["Pos"]	= Vector(-280, 215,-10)
	self.HP[2]["Angle"] = Angle(0,0,-80)
	self.HP[3]			= {}
	self.HP[3]["Ent"]	= nil
	self.HP[3]["Type"]	= {"Large","Heavy","SwivelMountC"}
	self.HP[3]["Pos"]	= Vector(-110,0,65)
...
function ENT:SpawnFunction( ply, tr )
	...
	local ent = ents.Create( "sbmp_corv_hermes" )
	ent:SetPos( SpawnPos )
	...
	ent2:SetPos( ent:LocalToWorld( Vector(280,0, -55) ) )
