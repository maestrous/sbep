...
function ENT:Initialize()
	...
	self.HP[1]["Ent"]	= nil
	self.HP[1]["Type"]	= "Tiny"
	self.HP[1]["Pos"]	= Vector(0,60,20)
	self.HP[1]["Angle"]	= Angle(0,90,0)
	self.HP[2]			= {}
	self.HP[2]["Ent"]	= nil
	self.HP[2]["Type"]	= "Tiny"
	self.HP[2]["Pos"]	= Vector(12,7,28)
	self.HP[2]["Angle"]	= Angle(0,90,0)
	self.HP[3]			= {}
	self.HP[3]["Ent"]	= nil
	self.HP[3]["Type"]	= "Tiny"
	self.HP[3]["Pos"]	= Vector(-12,7,28)
...
function ENT:SpawnFunction( ply, tr )
	...
	local ent = ents.Create( "SBEP-Hoverbike" )
	...
	ent2:SetModel( "models/hoverbike.mdl" ) 
	ent2:SetPos( SpawnPos )
	ent2:SetKeyValue("vehiclescript", "scripts/vehicles/hoverbike_script.txt")
	...
	ent2:SetNetworkedString( "WInfo", "Hoverbike", true )
	ent2.Cont = ent
...
function ENT:PreEntityCopy()
	...
	duplicator.StoreEntityModifier(self, "SBEPHoverbike", DI)
end
duplicator.RegisterEntityModifier( "SBEPHoverbike" , function() end)

function ENT:PostEntityPaste(pl, Ent, CreatedEntities)
	local DI = Ent.EntityMods.SBEPHoverbike
	...
	if(Ent.EntityMods and Ent.EntityMods.SBEPHoverbike.WireData) then
		WireLib.ApplyDupeInfo( pl, Ent, Ent.EntityMods.SBEPHoverbike.WireData, function(id) return CreatedEntities[id] end)
	end
