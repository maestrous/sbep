...
function ENT:Draw()
	...
	if self.Entity:GetActive() then
		...
		self.Entity:SetModel( "models/props_combine/portalball.mdl" )
		if self.Skin == 1 then
			self.Entity:SetColor( 240, 120, 50, 255 )
		elseif self.Skin == 2 then
			self.Entity:SetColor( 150, 150, 240, 255 )
		elseif self.Skin == 3 then
			self.Entity:SetColor( 100, 240, 100, 255 )
		elseif self.Skin == 4 then
			self.Entity:SetColor( 100, 100, 200, 255 )
		elseif self.Skin == 5 then
			self.Entity:SetColor( 240, 120, 120, 255 )
		else
