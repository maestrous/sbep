...
local DockingClampModelTable = {
			[ "models/SmallBridge/Ship Parts/sblandramp.mdl"  	] = { ListCat = "SmallBridge"	, ALType = "SWSHA", 
																	Compatible = { 	{ Type = "SWSHB", AF = 4.25, AYaw = 180 } } , 
																	EfPoints = 	{	{ x =  -65 , y = -110 , z =   50 , sp = 0 } , 
																					{ x =  -90 , y =   95 , z =  -60 , sp = 3 } , 
																					{ x =   90 , y =   95 , z =  -60 , sp = 0 } , 
																					{ x =   65 , y = -110 , z =   50 , sp = 1 } } } ,
			[ "models/SmallBridge/Ship Parts/sblanduramp.mdl"  	] = { ListCat = "SmallBridge"	, ALType = "SWSHB",
																	Compatible = { 	{ Type = "SWSHA", AF = 4.25, AYaw = 180 } } ,
																	EfPoints = {	{ x =  -65 , y =  100 , z =   60 , sp = 0 } , 
																					{ x =  -90 , y = -110 , z =  -50 , sp = 3 } , 
																					{ x =   90 , y = -110 , z =  -50 , sp = 0 } , 
																					{ x =   65 , y =  100 , z =   60 , sp = 1 } } } ,
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
			[ "models/SmallBridge/Panels/sbpaneldockin.mdl"  	] = { ListCat = "SmallBridge"	, ALType = "PLockA", 
																	Compatible = { 	{ Type = "PLockB", AF = -4.25 } }, 
																	EfPoints = {	{ x =  -60 , y =  -10 , z =   60 , sp = 1 } , 
																					...
																					{ x =   95 , y =  -10 , z =    0 , sp = 5 } , 
																					{ x =   60 , y =  -10 , z =   60 , sp = 0 } } } ,	
			[ "models/SmallBridge/Panels/sbpaneldockout.mdl"  	] = { ListCat = "SmallBridge"	, ALType = "PLockB",
																	Compatible = { 	{ Type = "PLockA", AF = -4.25 } },  
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
			[ "models/SmallBridge/Ship Parts/sblandrampdw.mdl"  ] = { ListCat = "SmallBridge"	, ALType = "DWSHA",
																	Compatible = {  { Type = "DWSHB", AF = -4.25, AYaw = 180} } , 
																	EfPoints = 	{	{ x = -175 , y = -110 , z =   50 , sp = 0 } , 
																					{ x = -200 , y =   95 , z =  -60 , sp = 3 } , 
																					{ x =  200 , y =   95 , z =  -60 , sp = 0 } , 
																					{ x =  175 , y = -110 , z =   50 , sp = 1 } } } ,
			[ "models/SmallBridge/Ship Parts/sblandurampdw.mdl"  ] = { ListCat = "SmallBridge"	, ALType = "DWSHB",
																	Compatible = {  { Type = "DWSHA", AF = -4.25, AYaw = 180} } , 
																	EfPoints = 	{	{ x = -175 , y =  100 , z =   60 , sp = 0 } , 
																					{ x = -200 , y = -110 , z =  -50 , sp = 3 } , 
																					{ x =  200 , y = -110 , z =  -50 , sp = 0 } , 
																					{ x =  175 , y =  100 , z =   60 , sp = 1 } } } ,
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
			[ "models/SmallBridge/Ship Parts/sblandrampdwdh.mdl" ] = { ListCat = "SmallBridge", ALType = "DWDHA", 
																	Compatible = {  { Type = "DWDHB", AF = -4.25, AYaw = 180} } ,
																	EfPoints = 	{	{ x = -175 , y = -110 , z =  180 , sp = 0 } , 
																					{ x = -200 , y =   90 , z =  -60 , sp = 3 } , 
																					{ x =  200 , y =   90 , z =  -60 , sp = 0 } , 
																					{ x =  175 , y = -110 , z =  180 , sp = 1 } } } ,
			[ "models/SmallBridge/Ship Parts/sblandurampdwdh.mdl"] = { ListCat = "SmallBridge"	, ALType = "DWDHB",
																	Compatible = {  { Type = "DWDHA", AF = -4.25, AYaw = 180} } ,
			...
			[ "models/SmallBridge/Elevators,Small/sbselevb.mdl"] = { ListCat = "ElevatorSmall"	, ALType = "ElevSU" ,
																	Compatible = { 	{ Type = "ElevSU", AU = 70, RYaw = 90, ARoll = 180 }, 
																					{ Type = "ElevSD", AU = 70, RYaw = 90 } },
																	EfPoints = 	{	{ x = -175 , y =  100 , z =  190 , sp = 0 } , 
																					{ x = -200 , y = -120 , z =  -60 , sp = 3 } , 
																					{ x =  200 , y = -120 , z =  -60 , sp = 0 } , 
																					{ x =  175 , y =  100 , z =  190 , sp = 1 } } } ,
			[ "models/SmallBridge/Elevators,Small/sbselevt.mdl"] = { ListCat = "ElevatorSmall"	, ALType = "ElevSD" , 
																	Compatible = { 	{ Type = "ElevSD", AU = -70, RYaw = 90, ARoll = 180 }, 
																					{ Type = "ElevSU", AU = -70, RYaw = 90 } },
																	EfPoints = 	{	{ x = -175 , y =  100 , z =  190 , sp = 0 } , 
																					{ x = -200 , y = -120 , z =  -60 , sp = 3 } , 
																					{ x =  200 , y = -120 , z =  -60 , sp = 0 } , 
																					{ x =  175 , y =  100 , z =  190 , sp = 1 } } }
