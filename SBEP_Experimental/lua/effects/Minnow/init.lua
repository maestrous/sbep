...
function EFFECT:Render()
	...
	self.Entity:SetModelScale(Vector(SzA,SzA,SzA))
	self.Entity:SetMaterial("models/alyx/emptool_glow")
	self:SetColor(100, 100, 200, Alpha)
	...
	self.Entity:SetModel(MOrb)
	self.Entity:SetModelScale(Vector(Sz,Sz,Sz) * 1.1)
	self.Entity:SetMaterial(MDst)
	self:SetColor(Alpha, Alpha, Alpha, Alpha)
	self.Entity:DrawModel()
