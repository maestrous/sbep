...
function ENT:Initialize()
	...
	self.Entity:SetName("RustBucketChopper")
...
function ENT:Think()
	...
	if self.RotorAng >= 360 then -- Yes, I could just use fmod, but I want to play a sound every time the rotors... rotate.
		...
		--self.RotorSounds[x]
		self.Entity:EmitSound("weapons/fx/nearmiss/bulletLtoR13.wav", 400, math.Clamp(self.RotorSpeed * 3,30,200))
	end
	...
	if self.Rotor && self.Rotor:IsValid() then
