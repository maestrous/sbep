...
function ENT:Think()
        ...
        local W = (math.sin(Cycle) * 0.002) * (self.VEn + self.SizeMin)
        --print(W)
        ...
        elseif Mutation == 1 then
                self:SetModelScale(Vector(Size - W,Size + W,Size + W) * 0.8)
                self:SetModel( "models/Weapons/w_bugbait.mdl" )
                self:SetMaterial()
        ...
        elseif Mutation == 2 then
                ...
                if !self.Accs[0] then
                        ...
                        Horn:SetModelScale(Vector(Size*HScale,Size*HScale,Size*HScale))
                end
        ...
        elseif Mutation == 3 then
                ...
                if !self.Accs[2] then
                        ...
                        Eye:SetModelScale(Vector(Size*HScale,Size*HScale,Size*HScale))
                end
                self.SizeMin = 1
                self.SizeMul = 0.05
                self.SizeSpeed = 0.1
        ...
        elseif Mutation == 10 then
                self:SetModelScale(Vector(Size - W,Size + W,Size + W) * 1)
                if self.VEn > 10 then
                        self.VEn = 10
                end
        ...
        elseif Mutation == 20 then
                ...
                if !self.Accs[0] then
                        ...
                        Spout:SetModelScale(Vector(Size*HScale,Size*HScale,Size*HScale))
                        ...
                        if !self.Accs[1] then
                                ...
                                Limb:SetPos( Pos )
                                Limb:SetModelScale(Vector(HScale,HScale,Length/27))
                        end
                end
