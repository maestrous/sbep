...
function ENT:Initialize()
	...
	self.Entity:SetModel( "models/SmallBridge/Ships/sbshuttlec1e1.mdl" ) 
	self.Entity:SetName("Shuttle2")
...
function ENT:SpawnFunction( ply, tr )
	...
	local ent = ents.Create( "sbmp_transport_shuttle2" )
	ent:SetPos( SpawnPos )
	ent:Spawn()
	ent:Initialize()
	ent:Activate()
	...
	ent2:SetPos( ent:LocalToWorld(Vector(75,0,-55)) )
