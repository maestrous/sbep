...
function ENT:Initialize()
	self.Entity:SetModel( "models/slyfo/cargoship.mdl" ) 
	self.Entity:SetName("Mover")
...
function ENT:SpawnFunction( ply, tr )
	...
	local ent = ents.Create( "sbmp_transport_mover" )
	ent:SetPos( SpawnPos )
	
	local ent2 = ents.Create( "prop_vehicle_prisoner_pod" )
	gamemode.Call("PlayerSpawnedVehicle",ply,ent2)
	ent2:SetModel( "models/slyfo/consolechair.mdl" )
	ent2:SetPos( ent:LocalToWorld( Vector(360,0,-40) ) )
