...
function ENT:Initialize()
	...
	self.HP[1]["Pos"]	= Vector(-30,-32,20)
	self.HP[1]["Angle"]	= Angle(0,90,0)
	self.HP[2]			= {}
	self.HP[2]["Ent"]	= nil
	self.HP[2]["Type"]	= "Small"
	self.HP[2]["Pos"]	= Vector(30,-32,20)
...
function ENT:SpawnFunction( ply, tr )
	...
	ent2:SetKeyValue("vehiclescript", "scripts/vehicles/airboat.txt")
	...
	ent2:SetNetworkedString( "WInfo", "Airboat", true )
	ent2.Cont = ent
...
function ENT:PreEntityCopy()
	...
	duplicator.StoreEntityModifier(self, "SBEPAirBoat", DI)
end
duplicator.RegisterEntityModifier( "SBEPAirBoat" , function() end)

function ENT:PostEntityPaste(pl, Ent, CreatedEntities)
	local DI = Ent.EntityMods.SBEPAirBoat
	...
	if(Ent.EntityMods and Ent.EntityMods.SBEPAirBoat.WireData) then
		WireLib.ApplyDupeInfo( pl, Ent, Ent.EntityMods.SBEPAirBoat.WireData, function(id) return CreatedEntities[id] end)
	end
