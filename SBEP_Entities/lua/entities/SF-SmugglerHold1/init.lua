...
function ENT:PreEntityCopy()
	...
	duplicator.StoreEntityModifier(self, "SBEPSmuggler1", DI)
end
duplicator.RegisterEntityModifier( "SBEPSmuggler1" , function() end)

function ENT:PostEntityPaste(pl, Ent, CreatedEntities)
	local DI = Ent.EntityMods.SBEPSmuggler1
	...
	if(Ent.EntityMods and Ent.EntityMods.SBEPSmuggler1.WireData) then
		WireLib.ApplyDupeInfo( pl, Ent, Ent.EntityMods.SBEPSmuggler1.WireData, function(id) return CreatedEntities[id] end)
	end
