...
function ENT:Initialize()
	...
	self.Entity:SetModel( "models/Slyfo/swordreconlauncher.mdl" )
	self.Entity:SetName("CarpetBombMount")
...
function ENT:BombDrop()
	...
	NewShell:SetPos( self.Entity:GetPos() + (self.Entity:GetUp() * -60 ) + self.Entity:GetForward() * math.random(-25,25) + self.Entity:GetRight() * math.random(-25,25) )
